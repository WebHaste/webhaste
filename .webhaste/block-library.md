...
Auto-generated by WebHaste — reflects the extension's built-in block library plus this site's custom blocks in `.webhaste/blocks/`, filtered to this site's current CSS framework (`bootstrap5`). Regenerated every time the project folder is opened in the editor — don't hand-edit, changes here won't stick.
